...
// The four traverser speeds, slowest → fastest. 'max' runs one tick per animation
...
// a single chevron (slowest) and a triple chevron (fastest). Click a notch, click/drag anywhere on the rail (snaps to
...
// joins — cf. TrashButton / the ExportMenu chain-link). A single chevron reads as "slow", a stack of
// three as "fast forward" — the same idiom as a media-player speed control.
function ChevronIcon() {
  return (
    <svg className="speedbar-icon" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false">
...
function ChevronsIcon() {
  return (
    <svg className="speedbar-icon" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false">
      <polyline points="2,5 7,12 2,19" />
